					...
					<div class="row">
						...
						<div class="col-md-3">
							...
							<!-- 		<li><a style="text-decoration:none; color:black;" href="">Quick-Start Guide</a></li> 
									...
									<li> <a style="text-decoration:none; color:black;" href="https://www.superiorideas.org/projects/open-source-psychology-software" target="_blank">Where to Donate?</a></li>
								</ul>
							</div>
						</div>
